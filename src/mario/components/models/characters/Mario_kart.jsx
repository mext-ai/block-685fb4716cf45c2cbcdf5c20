...
export function Mario({ currentSpeed, steeringAngleWheels, isBoosting, shouldLaunch, ...props }) {
  const { nodes, materials } = useGLTF('https://content.mext.app/uploads/2dfd6aaa-2df4-4de7-a590-58e916538ab5.glb')
...
useGLTF.preload('https://content.mext.app/uploads/2dfd6aaa-2df4-4de7-a590-58e916538ab5.glb')
